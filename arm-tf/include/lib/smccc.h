...
#define OEN_STRONGBOX_START	U(7)
#define OEN_STRONGBOX_END	U(7)		/* STRONGBOX */
#define OEN_HUSK_START	U(8)
#define OEN_HUSK_END	U(8)		/* husk */
#define OEN_ADD_GPU_BUFFER_START	U(9)
#define OEN_ADD_GPU_BUFFER_END	U(9)		/* husk */
